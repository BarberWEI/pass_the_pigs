...
public class BotPlayer extends Player{
    private static final String STRATEGY = "this bot goes for 23 because thats what i tested to be good value. however, it changes based on how close the bot is to winning, and how close opponents are to winning";
    ...
    // finds the value of the difference between the winning score and the highest scoring opponent
